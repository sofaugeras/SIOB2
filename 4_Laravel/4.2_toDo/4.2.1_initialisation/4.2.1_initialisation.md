...
!!! warning "Sécurité"
    ...
    GRANT ALL PRIVILEGES ON `todo2024`.* TO 'nouveau_utilisateur'@'localhost'; 
    FLUSH PRIVILEGES
    ```
...
??? question "Questions"
    === "Question"  
        À quoi correspond la méthode up et down ?<br />
...
```
Vérifier votre console et votre travail dans phpMyAdmin. Puis passer vos tables todo et user en moteur InnoDB au lieu de MyISAM.
