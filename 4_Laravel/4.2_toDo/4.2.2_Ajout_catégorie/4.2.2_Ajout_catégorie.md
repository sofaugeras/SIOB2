...
<br />
:arrow_forward: Je vous invite à debugger par vous même votre application

??? tips "Solutions"
    :arrow_forward: Reprendre la migration de la table d'association `create_categories_todos_table`
