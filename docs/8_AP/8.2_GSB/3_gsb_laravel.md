...
Le contexte GSB Laravel reprend le cahier des charges défini en première année sur le contexte [GSB Compte rendu de visite](1_gsb_v1.md). L'environnement technologique évolue. La DSI vous demande de faire évoluer votre application vers une [architecture MVC](../../7_Programmation/7.3_MVC_PHP/06_laravel.md), utilisant le [framework Laravel](../../4_Laravel/sommaire.md).
