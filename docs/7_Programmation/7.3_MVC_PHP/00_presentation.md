...
!!! note "Contexte"
    **Thème du cours :** Découverte du patron de conception **MVC** et de l'accès aux données dans une application web en PHP.
    ...
    ![logo](./data/licence.png){: width=10%} Licence Creative Commons « © Réseau CERTA – Ministère de l’Éducation Nationale – www.reseaucerta.org » 
...
![illustration](./data/schema_mvc.svg){: .center width=80%}
...
Le site **r3st0.local** est construit à l'image des sites de critique de restaurants existants (LaFourchette, TripAdvisor…).
...
![illustration diagramme de cas d'utilisation](./data/diagramme_cas_utilisation_r3st0.svg){: .center width=80%}

### 3.2 Modèle de données

Schéma relationnel de la base de données :

![bdd](./data/bdd.png){: .center width=100%}
