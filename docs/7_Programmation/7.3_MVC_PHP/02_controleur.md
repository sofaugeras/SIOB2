...
!!! info "Rappel sur les contrôleurs"
    ...
    ![illustration](./data/mvc_composants_annotes.svg){: .center width=100%}
...
## 1. Contrôleur de connexion : `connexion.php` 🔐

**Documents à utiliser :** fichiers du projet, annexes 1, 2, 3, 4

??? info "Annexe 1 - section de test du fichier modèle authentification.inc.php  📄"
    ...
    ```
??? info "Annexe 2 - résultat d'exécution du script authentification.inc.php  📄"
...
??? info "Annexe 3 - vueAuthentification.php 📄"
...
??? info "Annexe 4 -  contrôleur connexion.php à compléter 📄"
...
![illustration](./data/2schemaAuth.png){: .center width=80%}
...
??? question "Éléments de réponses ✅"
    ...
    ![illustration](./data/2schemaAuth_corr.png){: .center width=80%}
...
## 2. Contrôleur de déconnexion : `deconnexion.php` 🚪
...
??? info "Annexe 5 - contrôleur deconnexion.php à compléter  📄"
...
## 3. Contrôleur de recherche : `rechercheResto.php` 🔍

**Documents à utiliser :** fichiers du projet, annexes 6, 7, 8 et 9

??? info "Annexe 6 - contrôleur rechercheResto.php à compléter 📄"
...
??? info "Annexe 7 - vue vueRechercheResto.php 📄"
...
??? info "Annexe 8 - vue vueResultRecherche.php 📄"
...
??? info "Annexe 9 - extrait du modèle bd.resto.inc.php 📄"
...
## 4. Analyse de `rechercheResto.php` : gestion de l'affichage 🔍
...
## 5. Synthèse — Rôle et fonctionnement du contrôleur 📌
...
![illustration](./data/rechercheResto.png){: .center width=60%}
