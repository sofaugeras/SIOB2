...
CREATE TABLE IF NOT EXISTS `vol` (
  ...
  CONSTRAINT `fk_vol_numpilote` FOREIGN KEY (`NUMPILOTE`) REFERENCES `pilote` (`NUMPILOTE`),
  CONSTRAINT `fk_vol_numavion` FOREIGN KEY (`NUMAVION`) REFERENCES `avion` (`NUMAVION`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
